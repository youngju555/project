...
# 2️⃣ 카메라 보정값 로드
# ======================================================
def load_camera_params(yaml_path=r"C:\Users\fltmx\Downloads\camera_info.yaml"):
...
def detect_yolo(model, frame):
    ...
    results = model.predict(frame, imgsz=640, conf=0.6, verbose=False, device='0')
...
def main():
    ...
    parser.add_argument("--model", type=str, 
                        default=r"C:\Users\fltmx\Downloads\best (1).pt")
    ...
    # 카메라 보정값 로드 (경로 확인 필수)
    try:
        camera_matrix, dist_coeffs = load_camera_params(r"C:\Users\fltmx\Downloads\camera_info.yaml") # 윈도우 경로 예시
